...
$url        = 'https://go.microsoft.com/fwlink/?linkid=853016' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'mssqlserver2017dev*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'B7D3AC0D57B4D6C94EEC3541D8344F23F5FB24A700FE8C115745E1472BF9A4CD'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = 'B7D3AC0D57B4D6C94EEC3541D8344F23F5FB24A700FE8C115745E1472BF9A4CD'
  checksumType64= 'sha256' #default is checksumType

  # MSI
  # silentArgs    = "/qn /norestart /l*v `"$($env:TEMP)\$($packageName).$($env:chocolateyPackageVersion).MsiInstall.log`"" # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
  silentArgs    = " /IACCEPTSQLSERVERLICENSETERMS /Q /ACTION=install /INSTANCEID=MSSQLSERVER /INSTANCENAME=MSSQLSERVER /UPDATEENABLED=FALSE "
